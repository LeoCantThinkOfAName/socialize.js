    ...
    $.fn.Socialize = function(options) {
        ...
        let tempObj = options ? options : {},
            optionsObj = {
                ...
                icon: 'icon' in tempObj ? tempObj.icon : false,
                tagTitle: 'tagTitle' in tempObj ? tempObj.tagTitle : false
            }
        ...
        function onFacebook() {
            ...
            $this.bind('click', function() {
                ...
                window.open(`${Api.facebook[1]}${$url}`, 'share', `width=${optionsObj.width ? optionsObj.width : 300},height=${optionsObj.height ? optionsObj.height : 300}`);
            })
        }
